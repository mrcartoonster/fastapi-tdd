...
def test_read_summary(test_app, monkeypatch, test_data):
...
def test_read_all_summaries(test_app, monkeypatch, test_data_list):
    ...
    assert response.status_code == 200
    assert response.json() == test_data_list
